...
# For each dataset
for dataset in ['csl', 'capgmyo']: #['csl', 'hyser', 'capgmyo']: #, 'grabmyo-forearm', 'grabmyo-wrist']:
    exp['dataset'] = dataset
    if 'grabmyo' in dataset:
        ...
        if dataset == 'capgmyo':
            ...
            adapt_gest_subsets = [None, [20,22,23], [20]]  # For CSL, we can try different subsets
