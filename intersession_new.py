...
if __name__ == '__main__':
    ...
    subs, test_sessions, train_sessions, runs = [], [], [], []
    xshifts, yshifts = [], []
        ...
        for train_session in tqdm(data['sessions']):
            for test_session in tqdm(data['sessions']):
                ...
                for run in range(5):
                    ...
                    runs.append(run)
                    print('TEST SESSION #{}, dg: {}'.format(test_session, dg))
                    ...
                    adapt_loader = DataLoader(adapt_loader, batch_size=exp['batch_size'], shuffle=True)
