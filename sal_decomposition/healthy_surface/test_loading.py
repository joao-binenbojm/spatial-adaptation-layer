...
def loss_sampling(emg_grid_transform, sda, base_loss=1.0, batch_size=2048, num_points=20, loss='kurtosis', device='cpu'):
...
if __name__ == '__main__':
    ...
    inv_cov = get_inv_cov_torch(extended_emg, explained_var=1.0-1e-12)
